    ...
    describe('Empresa Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/empresas';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Empresa', () => {
                service.create(new Empresa(null)).subscribe(received => {
            ...
            it('should update a Empresa', () => {
                service.update(new Empresa(123)).subscribe(received => {
